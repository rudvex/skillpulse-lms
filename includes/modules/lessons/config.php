	...
	'fields' => array(
		array(
			...
			'options' => array(
				...
				array(
					'label' => __( 'Live Class (Zoom)', 'skillpulse-lms' ),
					'value' => 'live',
				),
			),
		),
		array(
			'id'          => 'live_session_date',
			'type'        => 'datetime',
			'label'       => __( 'Live Session Date & Time', 'skillpulse-lms' ),
			'help'        => __( 'When this live session is scheduled. A Zoom meeting will be created automatically when Zoom integration is enabled.', 'skillpulse-lms' ),
			'default'     => '',
			'value'       => splms_get_lesson_field_value( $splms_lesson_id, 'live_session_date', '', '' ),
			'column'      => 'half',
			'icon'        => 'calendar-alt',
			'placeholder' => __( 'Select date and time', 'skillpulse-lms' ),
			'conditional' => array(
				'key'   => 'lesson_type',
				'value' => 'live',
			),
		...
		array(
			'id'          => 'live_session_duration',
			'type'        => 'number',
			'label'       => __( 'Session Duration (minutes)', 'skillpulse-lms' ),
			'help'        => __( 'Duration of the live session in minutes.', 'skillpulse-lms' ),
			'default'     => 60,
			'value'       => splms_get_lesson_field_value( $splms_lesson_id, 'live_session_duration', '', 60 ),
			'column'      => 'half',
			'icon'        => 'clock',
			'min'         => 15,
			'max'         => 480,
		...
		array(
			'id'          => 'zoom_meeting_id',
			'type'        => 'text',
			'label'       => __( 'Zoom Meeting ID', 'skillpulse-lms' ),
			'help'        => __( 'Auto-populated when the meeting is created via Zoom integration.', 'skillpulse-lms' ),
			'default'     => '',
			'value'       => splms_get_lesson_field_value( $splms_lesson_id, 'zoom_meeting_id', '', '' ),
			'column'      => 'half',
			'icon'        => 'video-alt2',
			'readonly'    => true,
			'conditional' => array(
		...
		array(
			'id'          => 'zoom_join_url',
			'type'        => 'url',
			'label'       => __( 'Zoom Join URL', 'skillpulse-lms' ),
			'help'        => __( 'Students use this URL to join the live session.', 'skillpulse-lms' ),
			'default'     => '',
			'value'       => splms_get_lesson_field_value( $splms_lesson_id, 'zoom_join_url', '', '' ),
			'column'      => 'half',
			'icon'        => 'admin-links',
			'readonly'    => true,
			'conditional' => array(
		...
		array(
			'id'          => 'zoom_start_url',
			'type'        => 'url',
			'label'       => __( 'Zoom Start URL (Instructor)', 'skillpulse-lms' ),
			'help'        => __( 'Instructors use this URL to start the meeting as host.', 'skillpulse-lms' ),
			'default'     => '',
			'value'       => splms_get_lesson_field_value( $splms_lesson_id, 'zoom_start_url', '', '' ),
			'column'      => 'full',
			'icon'        => 'admin-links',
			'readonly'    => true,
			'conditional' => array(
