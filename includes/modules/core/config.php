...
$splms_all_settings = get_option( 'splms_settings' );
		...
		array(
			...
			'fields' => array(
				array(
					...
					'default'     => true,
					'value'       => isset( $splms_all_settings['general']['general_settings']['customize_login_screen'] ) ? $splms_all_settings['general']['general_settings']['customize_login_screen'] : true,
				),
				array(
					...
					'value'       => isset( $splms_all_settings['general']['general_settings']['login_welcome_title'] ) ? $splms_all_settings['general']['general_settings']['login_welcome_title'] : 'Welcome to {sitename}',
					'conditional' => array(
				...
				array(
					...
					'value'       => isset( $splms_all_settings['general']['general_settings']['login_welcome_subtitle'] ) ? $splms_all_settings['general']['general_settings']['login_welcome_subtitle'] : 'Sign in to continue your learning journey',
					'conditional' => array(
						'key'   => 'customize_login_screen',
						'value' => true,
					),
				...
				array(
					...
					'default'     => false,
					'value'       => isset( $splms_all_settings['general']['general_settings']['user_signup_enabled'] ) ? $splms_all_settings['general']['general_settings']['user_signup_enabled'] : false,
				),
				array(
					...
					'default'     => 'student',
					'value'       => isset( $splms_all_settings['general']['general_settings']['default_user_role'] ) ? $splms_all_settings['general']['general_settings']['default_user_role'] : 'student',
					'conditional' => array(
		...
		array(
			...
			'fields' => array(
				array(
					...
					'value'           => isset( $splms_all_settings['general']['pages_settings']['signup_page_id'] ) ? $splms_all_settings['general']['pages_settings']['signup_page_id'] : '',
				...
				array(
					...
					'default'         => '',
					'value'           => isset( $splms_all_settings['general']['pages_settings']['courses_page_id'] ) ? $splms_all_settings['general']['pages_settings']['courses_page_id'] : '',
					'options'         => splms_get_page_options(),
					'searchParam'     => 'search',
				...
				array(
					...
					'default'         => '',
					'value'           => isset( $splms_all_settings['general']['pages_settings']['dashboard_page_id'] ) ? $splms_all_settings['general']['pages_settings']['dashboard_page_id'] : '',
					'options'         => splms_get_page_options(),
					'searchParam'     => 'search',
				...
				array(
					...
					'value'           => isset( $splms_all_settings['general']['pages_settings']['logout_redirect_page_id'] ) ? $splms_all_settings['general']['pages_settings']['logout_redirect_page_id'] : '',
					'options'         => splms_get_page_options(),
					'searchParam'     => 'search',
				...
				array(
					...
					'value'           => isset( $splms_all_settings['general']['pages_settings']['terms_conditions_page_id'] ) ? $splms_all_settings['general']['pages_settings']['terms_conditions_page_id'] : '',
					'options'         => splms_get_page_options(),
					'searchParam'     => 'search',
				...
				array(
					...
					'value'           => isset( $splms_all_settings['general']['pages_settings']['privacy_policy_page_id'] ) ? $splms_all_settings['general']['pages_settings']['privacy_policy_page_id'] : '',
					'options'         => splms_get_page_options(),
					'searchParam'     => 'search',
		...
		array(
			...
			'fields' => array(
				array(
					...
					'default'     => false,
					'value'       => isset( $splms_all_settings['general']['maintenance_settings']['maintenance_mode'] ) ? $splms_all_settings['general']['maintenance_settings']['maintenance_mode'] : false,
				),
				array(
					...
					'value'       => isset( $splms_all_settings['general']['maintenance_settings']['maintenance_title'] ) ? $splms_all_settings['general']['maintenance_settings']['maintenance_title'] : 'Learning Platform Upgrade in Progress',
					'conditional' => array(
				...
				array(
					...
					'value'       => isset( $splms_all_settings['general']['maintenance_settings']['maintenance_message'] ) ? $splms_all_settings['general']['maintenance_settings']['maintenance_message'] : 'We\'re enhancing your learning experience! Our platform is temporarily offline while we upgrade our systems to serve you better.',
					'conditional' => array(
						'key'   => 'maintenance_mode',
						'value' => true,
					),
				...
				array(
					...
					'default'     => true,
					'value'       => isset( $splms_all_settings['general']['maintenance_settings']['maintenance_show_features'] ) ? $splms_all_settings['general']['maintenance_settings']['maintenance_show_features'] : true,
					'conditional' => array(
						'key'   => 'maintenance_mode',
						'value' => true,
					),
		...
		array(
			...
			'fields'      => array(
				array(
					...
					'default'     => true,
					'value'       => isset( $splms_all_settings['courses']['course_discovery']['course_search_enabled'] ) ? $splms_all_settings['courses']['course_discovery']['course_search_enabled'] : true,
				),
				array(
					...
					'default'     => true,
					'value'       => isset( $splms_all_settings['courses']['course_discovery']['course_categories_enabled'] ) ? $splms_all_settings['courses']['course_discovery']['course_categories_enabled'] : true,
				),
				array(
					...
					'default'     => true,
					'value'       => isset( $splms_all_settings['courses']['course_discovery']['course_tags_enabled'] ) ? $splms_all_settings['courses']['course_discovery']['course_tags_enabled'] : true,
				),
			),
		),
		array(
			...
			'fields'      => array(
				array(
					...
					'default'     => 12,
					'value'       => isset( $splms_all_settings['courses']['course_display']['course_item_per_page'] ) ? $splms_all_settings['courses']['course_display']['course_item_per_page'] : 12,
					'min'         => 1,
					'max'         => 50,
				),
				array(
					...
					'default'     => true,
					'value'       => isset( $splms_all_settings['courses']['course_display']['enable_related_courses'] ) ? $splms_all_settings['courses']['course_display']['enable_related_courses'] : true,
				),
			),
		),
		array(
			...
			'fields'      => array(
				array(
					...
					'default'     => true,
					'value'       => isset( $splms_all_settings['courses']['student_features']['enable_bookmarks'] ) ? $splms_all_settings['courses']['student_features']['enable_bookmarks'] : true,
				),
				array(
					...
					'default'     => true,
					'value'       => isset( $splms_all_settings['courses']['student_features']['enable_course_wishlist'] ) ? $splms_all_settings['courses']['student_features']['enable_course_wishlist'] : true,
				),
				array(
					...
					'default'     => true,
					'value'       => isset( $splms_all_settings['courses']['student_features']['enable_course_share'] ) ? $splms_all_settings['courses']['student_features']['enable_course_share'] : true,
				),
			),
		),
		array(
			...
			'fields'      => array(
				array(
					...
					'default'     => true,
					'value'       => isset( $splms_all_settings['courses']['course_reviews']['course_reviews_enabled'] ) ? $splms_all_settings['courses']['course_reviews']['course_reviews_enabled'] : true,
				),
				array(
					...
					'default'     => false,
					'value'       => isset( $splms_all_settings['courses']['course_reviews']['reviews_require_completion'] ) ? $splms_all_settings['courses']['course_reviews']['reviews_require_completion'] : false,
					'conditional' => array(
				...
				array(
					...
					'default'     => false,
					'value'       => isset( $splms_all_settings['courses']['course_reviews']['reviews_require_moderation'] ) ? $splms_all_settings['courses']['course_reviews']['reviews_require_moderation'] : false,
					'conditional' => array(
						'key'   => 'course_reviews_enabled',
						'value' => true,
					),
				...
				array(
					...
					'default'     => true,
					'value'       => isset( $splms_all_settings['courses']['course_reviews']['reviews_allow_admin'] ) ? $splms_all_settings['courses']['course_reviews']['reviews_allow_admin'] : true,
					'conditional' => array(
						'key'   => 'course_reviews_enabled',
						'value' => true,
					),
				...
				array(
					...
					'default'     => '24',
					'value'       => isset( $splms_all_settings['courses']['course_reviews']['reviews_edit_window'] ) ? $splms_all_settings['courses']['course_reviews']['reviews_edit_window'] : '24',
					'conditional' => array(
						'key'   => 'course_reviews_enabled',
						'value' => true,
					),
				...
				array(
					...
					'default'     => 10,
					'value'       => isset( $splms_all_settings['courses']['course_reviews']['reviews_min_length'] ) ? $splms_all_settings['courses']['course_reviews']['reviews_min_length'] : 10,
					'min'         => 0,
					'max'         => 100,
					'conditional' => array(
						'key'   => 'course_reviews_enabled',
				...
				array(
					...
					'default'     => 500,
					'value'       => isset( $splms_all_settings['courses']['course_reviews']['reviews_max_length'] ) ? $splms_all_settings['courses']['course_reviews']['reviews_max_length'] : 500,
					'min'         => 100,
					'max'         => 2000,
					'conditional' => array(
						'key'   => 'course_reviews_enabled',
		...
		array(
			...
			'fields'      => array(
				array(
					...
					'default'     => false,
					'value'       => isset( $splms_all_settings['courses']['enrollment_settings']['allow_student_unenrollment'] ) ? $splms_all_settings['courses']['enrollment_settings']['allow_student_unenrollment'] : false,
				),
			),
		),
		...
		array(
			...
			'fields' => array(
				array(
					...
					'default'     => true,
					'value'       => isset( $splms_all_settings['notifications']['email_settings']['enable_emails'] ) ? $splms_all_settings['notifications']['email_settings']['enable_emails'] : true,
				),
				array(
					'id'          => 'from_name',
					'type'        => 'text',
					...
					'value'       => isset( $splms_all_settings['notifications']['email_settings']['from_name'] ) ? $splms_all_settings['notifications']['email_settings']['from_name'] : '',
				),
				array(
					'id'          => 'from_email',
					'type'        => 'email',
					...
					'value'       => isset( $splms_all_settings['notifications']['email_settings']['from_email'] ) ? $splms_all_settings['notifications']['email_settings']['from_email'] : '',
				),
				array(
					...
					'default'     => false,
					'value'       => isset( $splms_all_settings['notifications']['email_settings']['email_queue_enabled'] ) ? $splms_all_settings['notifications']['email_settings']['email_queue_enabled'] : false,
				),
				array(
					...
					'default'     => 50,
					'value'       => isset( $splms_all_settings['notifications']['email_settings']['batch_email_limit'] ) ? $splms_all_settings['notifications']['email_settings']['batch_email_limit'] : 50,
					'min'         => 10,
					'max'         => 200,
				),
				array(
					...
					'default'     => 60,
					'value'       => isset( $splms_all_settings['notifications']['email_settings']['queue_processing_interval'] ) ? $splms_all_settings['notifications']['email_settings']['queue_processing_interval'] : 60,
					'min'         => 30,
					'max'         => 300,
				),
				array(
					...
					'default'     => false,
					'value'       => isset( $splms_all_settings['notifications']['email_settings']['use_smtp'] ) ? $splms_all_settings['notifications']['email_settings']['use_smtp'] : false,
				),
				array(
					'id'          => 'smtp_host',
					'type'        => 'text',
					...
					'value'       => isset( $splms_all_settings['notifications']['email_settings']['smtp_host'] ) ? $splms_all_settings['notifications']['email_settings']['smtp_host'] : '',
					'conditional' => array(
						'key'   => 'use_smtp',
						'value' => true,
					),
				...
				array(
					...
					'default'     => 587,
					'value'       => isset( $splms_all_settings['notifications']['email_settings']['smtp_port'] ) ? $splms_all_settings['notifications']['email_settings']['smtp_port'] : 587,
					'min'         => 1,
					'max'         => 65535,
					'conditional' => array(
						'key'   => 'use_smtp',
				...
				array(
					...
					'default'     => 'tls',
					'value'       => isset( $splms_all_settings['notifications']['email_settings']['smtp_encryption'] ) ? $splms_all_settings['notifications']['email_settings']['smtp_encryption'] : 'tls',
					'conditional' => array(
						'key'   => 'use_smtp',
						'value' => true,
					),
				...
				array(
					...
					'value'       => isset( $splms_all_settings['notifications']['email_settings']['smtp_username'] ) ? $splms_all_settings['notifications']['email_settings']['smtp_username'] : '',
					'conditional' => array(
						'key'   => 'use_smtp',
						'value' => true,
					),
				...
				array(
					...
					'value'       => isset( $splms_all_settings['notifications']['email_settings']['smtp_password'] ) ? $splms_all_settings['notifications']['email_settings']['smtp_password'] : '',
					'conditional' => array(
						'key'   => 'use_smtp',
						'value' => true,
					),
		...
		array(
			...
			'fields' => array(
				array(
					...
					'default'     => true,
					'value'       => isset( $splms_all_settings['notifications']['in_app_settings']['enable_in_app_notifications'] ) ? $splms_all_settings['notifications']['in_app_settings']['enable_in_app_notifications'] : true,
				),
				array(
					...
					'default'     => 100,
					'value'       => isset( $splms_all_settings['notifications']['in_app_settings']['max_notifications_per_user'] ) ? $splms_all_settings['notifications']['in_app_settings']['max_notifications_per_user'] : 100,
					'min'         => 1,
					'max'         => 10000,
				),
				array(
					...
					'default'     => false,
					'value'       => isset( $splms_all_settings['notifications']['in_app_settings']['auto_delete_enabled'] ) ? $splms_all_settings['notifications']['in_app_settings']['auto_delete_enabled'] : false,
				),
				array(
					'id'          => 'auto_delete_days',
					'type'        => 'number',
					...
					'default'     => 90,
					'value'       => isset( $splms_all_settings['notifications']['in_app_settings']['auto_delete_days'] ) ? $splms_all_settings['notifications']['in_app_settings']['auto_delete_days'] : 90,
					'min'         => 1,
					'max'         => 3650,
					'conditional' => array(
				...
				array(
					...
					'default'     => 'info',
					'value'       => isset( $splms_all_settings['notifications']['in_app_settings']['default_notification_type'] ) ? $splms_all_settings['notifications']['in_app_settings']['default_notification_type'] : 'info',
				),
			),
		),
	),
