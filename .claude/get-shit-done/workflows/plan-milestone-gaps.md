...
PHASES=$(node "/Users/hardip/Workspace/devilbox/data/www/sp-lms/htdocs/wp-content/plugins/skillpulse-lms/.claude/get-shit-done/bin/gsd-tools.cjs" phases list)
...
```bash
node "/Users/hardip/Workspace/devilbox/data/www/sp-lms/htdocs/wp-content/plugins/skillpulse-lms/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs(roadmap): add gap closure phases {N}-{M}" --files .planning/ROADMAP.md .planning/REQUIREMENTS.md
```
