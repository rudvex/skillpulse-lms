...
$splms_signup_page_id = splms_get_setting( 'signup_page_id', 0 );
$splms_signup_url     = $splms_signup_page_id ? get_permalink( $splms_signup_page_id ) : wp_registration_url();
?>
...
<div class="splms-login-required-wrapper">
	<div class="splms-login-required-card">
		...
		<div class="splms-login-actions">
			...
			<?php if ( get_option( 'users_can_register' ) || $splms_signup_page_id ) : ?>
				<a href="<?php echo esc_url( $splms_signup_url ); ?>" class="splms-btn splms-btn-secondary">
					<svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
