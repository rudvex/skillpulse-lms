<?php
/**
 * Course tag taxonomy archive template
 *
...
$splms_setup_data = SkillPulse_LMS_Course_Frontend::get_course_archive_setup( 'tag', $splms_current_term );
		...
		<div class="splms-archive-title">
			...
			<?php } else { ?>
				<p class="archive-subtitle">
					...
					printf( esc_html__( 'Discover courses tagged with %s', 'skillpulse-lms' ), esc_html( single_term_title( '', false ) ) );
					?>
				</p>
			<?php } ?>
		</div>
