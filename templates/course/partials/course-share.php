 ...
 *
 * Displays social sharing buttons for course completion.
 *
...
<div class="splms-course-share">
	<h4 class="splms-course-share__title">
		<?php esc_html_e( 'Share Your Achievement', 'skillpulse-lms' ); ?>
	</h4>
	<p class="splms-course-share__description">
		<?php esc_html_e( 'Let others know about your accomplishment!', 'skillpulse-lms' ); ?>
	</p>
	...
	<div class="splms-course-share__buttons">
		<a href="<?php echo esc_url( $facebook_url ); ?>" 
			...
			aria-label="<?php esc_attr_e( 'Share on Facebook', 'skillpulse-lms' ); ?>">
		...
		<a href="<?php echo esc_url( $twitter_url ); ?>" 
			...
			aria-label="<?php esc_attr_e( 'Share on Twitter', 'skillpulse-lms' ); ?>">
			<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
		...
		<a href="<?php echo esc_url( $linkedin_url ); ?>" 
			...
			aria-label="<?php esc_attr_e( 'Share on LinkedIn', 'skillpulse-lms' ); ?>">
			<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
		...
		<a href="<?php echo esc_url( $whatsapp_url ); ?>" 
			...
			aria-label="<?php esc_attr_e( 'Share on WhatsApp', 'skillpulse-lms' ); ?>">
			<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
			...
			<span><?php esc_html_e( 'WhatsApp', 'skillpulse-lms' ); ?></span>
		</a>
	...
	<div class="splms-course-share__message" style="display: none;">
		<?php esc_html_e( 'Link copied to clipboard!', 'skillpulse-lms' ); ?>
	</div>
</div>
